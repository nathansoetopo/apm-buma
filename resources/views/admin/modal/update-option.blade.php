...
<div class="modal fade" tabindex="-1" role="dialog" id="modalUpdateData{{ $o->id }}">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="createRecord" action="{{ url('/admin/quiz/'.$questionID.'/update-option') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Update Option</h5>
