...
<body>
    ...
    <div class="main-wrapper">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div> Supported By <a href="https://nauval.in/">LanternTech</a>
        </div>
  ...
  <script>
    var dumy = [1,2,3]
    fetch_user_data(dumy);
    function fetch_user_data(dumy)
    {
      $.ajax({
        headers: {
        ...
        url:"{{ url('/uji-coba') }}",
        method:'POST',
        data:{nilai:JSON.stringify(dumy)},
        dataType: "json",
        traditional: true,
