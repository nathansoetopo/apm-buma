        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-12 mb-5">
                    <div class="card" style="border-color: #0E9C4A; border-style:solid;">
                        <div class="card-body">
                            <h4 class="card-title" style="background-color:#33FF00; height:270px; border-radius:15px">
                                <center>
                                    <h1 style="padding-top: 20px;">Normal</h1>
                                    <h1></br></h1>
                                    <h1>150,0</h1>
                                    <h1>mili detik</h1>
                            ...
                            <b>
                                <p class="card-text">Indikator Nilai</p>
                            </b>
                            </br>
                            <div class="row">
                                <div class="col-md-6 col-lg-1 mb-5">
                                    <h4 class="" style="background-color:#33FF00; height:70px">
                                    </h4>
                                </div>
                                <div class="col-md-6 col-lg-6 mb-5">
                                    <p>Normal (N)</p>
                                    <p>Waktu reaksi 150,0 - 240,0 milidetik</p>
                                </div>
                            </div>
                            <div class="row">
                            <div class="col-md-6 col-lg-1 mb-5">
                                <h4 class="" style="background-color:#FAFF00; height:70px">
                                </h4>
                            </div>
                            <div class="col-md-6 col-lg-6 mb-5">
                                    <p>Kelelahan Kerja Ringan (KKR)</p>
                                    <p>Waktu reaksi ≥ 240,0 - 410,0 milidetik</p>
                                </div>
                            </div>
                            <div class="row">
                            <div class="col-md-6 col-lg-1 mb-5">
                                <h4 class="" style="background-color:#FFA800; height:70px">
                                </h4>
                            </div>
                            <div class="col-md-6 col-lg-6 mb-5">
                                    <p>Kelelahan Kerja Sedang (KKS)</p>
                                    <p>Waktu reaksi ≥ 410,0 - 580,0 milidetik</p>
                                </div>
                            </div>
                            <div class="row">
                            <div class="col-md-6 col-lg-1 mb-5">
                                <h4 class="" style="background-color:#FF0000; height:70px">
                                </h4>
                            </div>
                            <div class="col-md-6 col-lg-6 mb-5">
                                    <p>Kelelahan Kerja Berat (KKB)</p>
                                    <p>Waktu reaksi ≤ 580,0 milidetik</p>
                                </div>
                            </div>
