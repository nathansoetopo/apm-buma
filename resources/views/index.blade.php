            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-3 col-6 mb-5">
                    <div class="card">
                        ...
                        <h4 class=""
                            style="background-image: url('startboot/assets/nilaibg.png'); background-size: cover; height:200px;">
                            <center>
                                <br>
                                <b>150,0</b>
                                <p>-</p>
                ...
                <div class="col-md-6 col-lg-3 col-6 mb-5">
                    <div class="card">
                        <img class="card-img-top">
                        <h4 class=""
                            style="background-image: url('startboot/assets/nilaibg-kkr.png'); background-size: cover; height:200px">
                            <br>
                            <center>
                                <b>240,0</b>
                                <p>-</p>
                ...
                <div class="col-md-6 col-lg-3 col-6 mb-5">
                    <div class="card">
                        <img class="card-img-top">
                        <h4 class=""
                            style="background-image: url('startboot/assets/nilaibg-kks.png'); background-size: cover; height:200px">
                            <br>
                            <center>
                                <b>410,0</b>
                                <p>-</p>
                ...
                <div class="col-md-6 col-lg-3 col-6 mb-5">
                    <div class="card">
                        <img class="card-img-top">
                        <h4 class=""
                            style="background-image: url('startboot/assets/nilaibg-kkb.png'); background-size: cover; height:200px">
                            <br>
                            <center>
                                <p class="text-dark">>=</p>
